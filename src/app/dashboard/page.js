...
import { faAdd, faCarSide, faCirclePlus } from "@fortawesome/free-solid-svg-icons";
      ...
      <div className="bg-gray-300 min-h-[60%] h-auto flex justify-center items-center ">
        ...
        >
          {(fetchedProducts && fetchedProducts.length!=0) ? (
            ...
            <div className="text-gray-500 w-full flex flex-col gap-2 bg-white rounded-md justify-center items-center border-dashed border-gray-600 border-2 hover:scale-105 transition-transform duration-300 ease-in-out cursor-default">
